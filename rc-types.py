...
# Read a CONLL-U file
doc = udapi.Document()
doc.load_conllu(filename="en_ewt-ud-train.conllu")
            ...
            for node in root.descendants:
                ...
                if node.deprel in ("acl:relcl", "advcl:relcl"):
                    ...
                    if rctype != "free":
                        ...
                        # TODO: what is the purpose of the code below? How come the predicae has the feature being REL?
                    ...
                    while edep and edep["parent"] is not head: # TODO: why?

                        r = edep["deprel"]

                        if r.endswith(
                                (":about", ":after", ":as", ":at", ":besides", ":for", ":from", ":in", ":inside", ":into",
                    ...
                    for lastChInRC in eltsInRC[::-1]:
                        if lastChInRC.deprel in ("punct", "advmod", "advcl"):
                            ...
                            lastInRC = list(
                                filter(lambda n: n.deprel not in ("punct", "advmod", "advcl"),
                            ...
                            if lastInRC.upos == "ADP" and lastInRC.deprel != "compound:prt":
                                ...
                                if not any(e.endswith((":as", ":like", ":than")) for e in ee) and not (
                                    ...
                                    assert (lastInRC.misc["Promoted"] == "Yes") ^ (
                                            lastInRC.parent is wh and lastInRC.deprel in ("cop", "aux", "aux:pass")), (
                                        lastInRC, edeprels)
                                break
...
output_file_path = "filtered_out.conllu"
